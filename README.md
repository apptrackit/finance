...
| MCP review | Prepare income, expense, or cash transfer drafts in conversation; list and correct unlinked drafts; review and confirm or decline drafts and transfer pairs in the app. |
...
The optional MCP Worker accesses D1 directly. Most tools read bounded financial summaries or transaction history. Its writes are limited to stored proposals, pending MCP review draft creation and correction, and immutable forecast snapshots.
